...
kubectl create secret generic secret-config -n $1 \
	...
	--from-file=./config/integration/MONGO_ADM_USER \
	--from-file=./config/integration/MONGO_ADM_PASSWORD \
	--from-file=./config/integration/MONGO_APP_USER \
	--from-file=./config/integration/MONGO_APP_PASSWORD \
